function [pks, outbin, ready] = spectrometer (sample1, sample2)
    ...
    [pk1, outbin, ready] = noaverage_instance:P1:part=real_(ch1_val, ch1_val, bin, cready);
    [pk2, outbin, ready] = noaverage_instance:P2:part=real_(ch2_val, ch2_val, bin, cready);
    [pkr, outbin, ready] = noaverage_instance:P3:part=real_(ch1_val, ch2_val, bin, cready);
    [pki, outbin, ready] = noaverage_instance:P4:part=imag_(ch1_val, ch2_val, bin, cready);
    pks = [pk1,pk2,pkr,pki];
    c=c+1;
end
